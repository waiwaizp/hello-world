...
import { get_orders } from '../utils/rpc'
...
class TradeStore {
  ...
  constructor(rootStore) {
    ...
    const base = 'EOS@eosio.token'
    const quote = 'MEETONE@eosiomeetone'
    ...
    set(this, {
      get buyOrders() {
        return get_orders(base, quote, 1)
      }
    })

    set(this, {
      get sellOrders() {
        return get_orders(base, quote, 0)
      }
    })
